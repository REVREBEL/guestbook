...
export function TimelineForm(
    {
        ...
        buttonSubmitButtonColorVariant = null,
    ...
    return (
        <_Component className="on-click_form is-timeline-form" tag="section"><_Builtin.Block className="timeline_form-padding" tag="div"><_Builtin.Block className="timeline_form_inner-form" tag="div"><_Builtin.Block className="timeline_form_component" tag="div"><_Builtin.Block
                            className="timeline_form-card"
                            id="w-node-df77b4d3-339b-ce01-8ef0-7023c33009ae-c33009aa"
                            tag="div"><_Builtin.Block className="form-headline_wrapper" tag="div"><_Builtin.Heading className="heading_h3" tag="h1">{"timleine journal"}</_Builtin.Heading><_Builtin.Block className="close-button" tag="div" /></_Builtin.Block><_Builtin.FormWrapper className="timeline_form_componentt"><_Builtin.FormForm
                                    ...
                                    id="wf-form-Add-a-Milestone"><_Builtin.Block className="timeline_form_column-group" tag="div"><_Builtin.Block className="timeline_form-column" tag="div"><_Builtin.Heading className="timeline_form-card-heading" tag="h1">{"add a "}<_Builtin.Span className="italic">{"m"}</_Builtin.Span>{"ilestone"}<br /><_Builtin.Span className="text-size_2rem is-right">{"to her story +timeline"}</_Builtin.Span></_Builtin.Heading>{timelineDateFieldFormInputVisibility ? <_Builtin.Block className="form_field-wrapper margin-top_20pct" tag="div">{timelineDetailFieldFormInputVisibility ? <_Builtin.Block className="text-area_component margin-top_none" tag="div"><_Builtin.Block className="form_field-wrapper" tag="div"><_Builtin.FormBlockLabel className="input_label" htmlFor="Phone">{"Main Headline Description"}</_Builtin.FormBlockLabel><_Builtin.FormTextInput
                                                            ...
                                                            {...timelineNameLine1FormInputRuntimeProps} /></_Builtin.Block>{tImelineNameLine2FormInputVisibility ? <_Builtin.Block className="form_field-wrapper" tag="div"><_Builtin.FormBlockLabel className="input_label" htmlFor="Phone">{"Sub-Headline Description"}</_Builtin.FormBlockLabel><_Builtin.Block className="form-field_icon-component" tag="div"><_Builtin.FormTextInput
                                                                className="input_field"
                                                                ...
                                                                {...tImelineNameLine2FormInputRuntimeProps} /></_Builtin.Block></_Builtin.Block> : null}<_Builtin.Block className="form_field-wrapper is-height_200px" tag="div"><_Builtin.FormTextarea
                                            ...
                                            tag="div"><_Builtin.Block className="timeline-form_name-group" tag="div">{locationFieldFormInputVisibility ? <_Builtin.Block
                                                    ...
                                                    className="form_field-wrapper"
                                                    tag="div"
                                                    {...timelineDateFieldFormSectionRuntimeProps}>{timelineDateFieldFormSectionSlot ?? <><_Builtin.FormBlockLabel className="input_label" htmlFor="Phone">{"Milestone Month + Date "}<br /><_Builtin.Span className="text-span-24">{"(SUPPORTS a specific date ALSO) "}</_Builtin.Span></_Builtin.FormBlockLabel><_Builtin.Block className="form-field_icon-component" tag="div">{timelineDateFieldIconVisibility ? <_Builtin.HtmlEmbed
                                                                className="calendar-icon"
                                                                value="%3C%3Fxml%20version%3D%221.0%22%20encoding%3D%22UTF-8%22%3F%3E%3Csvg%20width%3D%2224px%22%20height%3D%2224px%22%20stroke-width%3D%221.5%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20color%3D%22currentColor%22%3E%3Cpath%20d%3D%22M15%204V2M15%204V6M15%204H10.5M3%2010V19C3%2020.1046%203.89543%2021%205%2021H19C20.1046%2021%2021%2020.1046%2021%2019V10H3Z%22%20stroke%3D%22currentColor%22%20stroke-width%3D%221.5%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3C%2Fpath%3E%3Cpath%20d%3D%22M3%2010V6C3%204.89543%203.89543%204%205%204H7%22%20stroke%3D%22currentColor%22%20stroke-width%3D%221.5%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3C%2Fpath%3E%3Cpath%20d%3D%22M7%202V6%22%20stroke%3D%22currentColor%22%20stroke-width%3D%221.5%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3C%2Fpath%3E%3Cpath%20d%3D%22M21%2010V6C21%204.89543%2020.1046%204%2019%204H18.5%22%20stroke%3D%22currentColor%22%20stroke-width%3D%221.5%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3C%2Fpath%3E%3C%2Fsvg%3E" /> : null}<_Builtin.FormTextInput
                                                                className="input_field is-icon"
                                                                name="timeline_date"
                                                                maxLength={256}
                                                                ...
                                                                {...timelineDateFieldFormInputRuntimeProps} /></_Builtin.Block></>}</_Builtin.Block></_Builtin.Block></_Builtin.Block></_Builtin.Block><_Builtin.Block className="timeline_form_column-group" tag="div"><_Builtin.Block className="timeline_form-columns" tag="div"><_Builtin.Block
                                                className="form_field-wrapper is-content-block"
                                                tag="div"
                                                id="Content-Link-ID"><_Builtin.Heading className="timeline-form_content-heading-copy" tag="h1">{addContentHeadlineText}</_Builtin.Heading><_Builtin.Paragraph className="timeline-form_content-paragraph">{addContentParagraphText}</_Builtin.Paragraph></_Builtin.Block><_Builtin.Block className="space_25px" tag="div" /><_Builtin.Block className="form_field-wrapper is-file-upload" tag="div"><_Builtin.Block className="upload-file-wrapper" tag="div"><_Builtin.Block className="form_input-background is-timeline" tag="div"><_Builtin.Block
                                                            className="form-input_image-upload image-1"
                                                            data-w-id="91a8e13d-edc8-56e1-79ba-812d539cc6e5"
                                                            tag="div"
                                                            ...
                                                            data-w-id="8432e584-73f2-4805-ccca-e48e1cdc08b3"
                                                            tag="div"
                                                            ...
                                                            tag="div"
                                                            data-file-upload="compressing"
                                                            id="animation_upload-photo-2" /></_Builtin.Block></_Builtin.Block></_Builtin.Block><_Builtin.Block className="space-50" tag="div" /><_Builtin.Block className="space-50" tag="div" /><_Builtin.Block className="form_field-wrapper is-content-block" tag="div"><_Builtin.Heading className="timeline-form_content-heading-copy" tag="h1">{"the contributor"}</_Builtin.Heading></_Builtin.Block></_Builtin.Block><_Builtin.Block
                                            className="timeline_form-columns"
                                            ...
                                            tag="div"><_Builtin.Block className="timeline-form_name-group" tag="div">{fullNameFieldFormInputVisibility ? <_Builtin.Block className="form_field-wrapper" tag="div"><_Builtin.FormBlockLabel className="input_label" htmlFor="Phone">{fullNameFieldFormInputLabel}</_Builtin.FormBlockLabel><_Builtin.Block className="form-field_icon-component" tag="div"><_Builtin.HtmlEmbed
                                                    ...
                                                    className="form_field-wrapper"
                                                    tag="div"
                                                    {...emailFieldFormSectionRuntimeProps}>{emailFieldFormSectionSlot ?? <><_Builtin.FormBlockLabel className="input_label" htmlFor="Phone">{"Email *"}</_Builtin.FormBlockLabel><_Builtin.Block className="form-field_icon-component" tag="div">{emailFieldIconVisibility ? <_Builtin.HtmlEmbed
